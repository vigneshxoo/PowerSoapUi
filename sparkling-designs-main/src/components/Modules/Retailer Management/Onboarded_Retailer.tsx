        ...
        <div className="min-h-screen bg-gray-50/30 text-slate-900 relative">
            ...
            <main className="lg:ml-64 min-h-screen flex flex-col">
                ...
                <div className="p-4 sm:p-6 lg:p-10 xl:p-12 max-w-[1600px] mx-auto w-full space-y-6 lg:space-y-8">
                    ...
                    <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6">
                        <div className="space-y-2" data-aos="fade-right">
                            ...
                            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight">
                                Retailer <span className="text-[#D11C78]">List</span>
                            </h1>
                    ...
                    {/* FILTERS & SEARCH */}
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-gray-200 shadow-sm" data-aos="fade-up" data-aos-delay="150">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <button className="px-6 py-3 bg-[#D11C78] text-white rounded-xl font-bold text-sm uppercase tracking-wider shadow-md hover:opacity-90 transition-all active:scale-95">
                                Go
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left min-w-[1050px]">
                                <thead className="bg-gray-50 border-b border-gray-100">
                                    <tr>
                                        <th className="px-5 py-4 text-[12px] font-black uppercase text-gray-500 tracking-wider">Retailer Info</th>
                                        <th className="px-5 py-4 text-[12px] font-black uppercase text-gray-500 tracking-wider">Store Type</th>
                                        <th className="px-5 py-4 text-[12px] font-black uppercase text-gray-500 tracking-wider">Contact details</th>
                                        <th className="px-5 py-4 text-[12px] font-black uppercase text-gray-500 tracking-wider">Financials</th>
                                        <th className="px-5 py-4 text-[12px] font-black uppercase text-gray-500 tracking-wider">Paid Amount</th>
                                        <th className="px-5 py-4 text-[12px] font-black uppercase text-gray-500 tracking-wider text-right">Actions</th>
                                    </tr>
                                </thead>
                                    ...
                                    {mokeRetailers.map((shop) => (
                                        <tr key={shop.code} className="hover:bg-blue-50/40 transition-colors group">
                                            <td className="px-5 py-5">
                                                <Link to={'/Reaitler_takeorder'} className="font-bold text-blue-500 text-sm md:text-base group-hover:translate-x-1 transition-transform">#{shop.code}</Link>
                                                <p className="text-gray-900 font-bold text-base mt-0.5 leading-tight">{shop.name}</p>
                                                <p className="text-[10px] text-gray-500 font-bold mt-1 uppercase tracking-wider">Joined: {shop.date}</p>
                                            </td>
                                            <td className="px-5 py-5">
                                                <span className={`px-3 py-1.5 rounded-xl font-bold text-[12px] uppercase tracking-wider ${shop.type === 'Retailer' ? 'bg-orange-50 text-orange-600 border border-orange-100' : 'bg-purple-50 text-purple-600 border border-purple-100'}`}>
                                                    {shop.type}
                                                </span>
                                            </td>
                                            <td className="px-5 py-5">
                                                <p className="font-bold text-gray-800 text-l">{shop.mobile}</p>
                                                <p className="text-[13px] text-gray-600 font-semibold mt-0.5">POC: {shop.contact}</p>
                                            </td>
                                            <td className="px-5 py-5">
                                                <div className="space-y-0.5">
                                                    <p className="text-[12px] text-gray-400 font-bold uppercase tracking-wider">Outstanding</p>
                                            ...
                                            <td className="px-5 py-5">
                                                <p className="font-bold text-primary text-[20px] text-base">₹12,348</p>
                                            </td>
            ...
            {click && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 overflow-y-auto">
                    <div 
                        className="bg-white rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden relative my-auto border border-gray-100"
                        data-aos="zoom-in"
                    ...
                    >
                        ...
                        <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-white relative z-10">
                            <div>
                                <h2 className="text-2xl font-black text-[#D11C78]">Add New Retailer</h2>
