                    ...
                    <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6">
                        <div className="space-y-2">
                            ...
                            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight text-slate-900 leading-tight">
                                Retailer <span className="text-primary">Requests</span>
                            </h1>
                        ...
                        <div className="flex flex-wrap p-1.5 bg-gray-50/80 rounded-2xl border border-gray-200 gap-1 sm:gap-2">
                            ...
                            <table className="w-full text-left min-w-[1000px]">
                                <thead className="bg-gray-50 border-b border-gray-100">
                                    <tr>
                                        ...
                                        <th className="px-5 py-4 text-[11px] font-black uppercase text-gray-400 tracking-wider">S.No</th>
                                        <th className="px-5 py-4 text-[11px] font-black uppercase text-gray-400 tracking-wider">Retailer Information</th>
                                        <th className="px-5 py-4 text-[11px] font-black uppercase text-gray-400 tracking-wider">Contact Details</th>
                                        <th className="px-5 py-4 text-[11px] font-black uppercase text-gray-400 tracking-wider">Applied Date</th>
                                        <th className="px-5 py-4 text-[11px] font-black uppercase text-gray-400 tracking-wider ">Licencse NUM</th>
                                        <th className="px-5 py-4 text-[11px] font-black uppercase text-gray-400 tracking-wider text-right">Status Action</th>
                                    </tr>
                                </thead>
                                    ...
                                    {mokeRequests.map((req) => (
                                        <tr key={req.code} className="hover:bg-blue-50/30 transition-colors group">
                                            <td className="px-5 py-5">
                                                <span className="font-black text-gray-400 text-sm group-hover:text-primary transition-colors">
                                                    {String(req.id).padStart(2, '0')}
                                                </span>
                                            </td>
                                            <td className="px-5 py-5">
                                                <div className="space-y-1">
                                                    <p className="font-bold text-gray-900 text-sm md:text-base leading-tight">{req.name}</p>
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-primary font-bold text-[11px]">#{req.code}</span>
                                                        <span className="h-1 w-1 rounded-full bg-gray-300" />
                                                        <span className="text-gray-500 font-bold text-[10px] uppercase tracking-wider">{req.type}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-5 py-5">
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="text-[11px] text-gray-400 font-semibold ml-5 uppercase tracking-wider">POC: {req.contact}</p>
                                                </div>
                                            </td>
                                            <td className="px-5 py-5">
                                                <div className="flex flex-col">
                                                    <p className="font-bold text-gray-800 text-sm">{req.date.split(' ')[0]}</p>
                                                    <p className="text-[11px] text-gray-400 font-medium mt-0.5">{req.date.split(' ')[1]}</p>
                                                </div>
                                            </td>
                                            <td className="px-5 py-5">
                                                <div className="flex flex-col">
                                            ...
                                            <td className="px-5 py-5 text-right">
                                                ...
                                                <div className="inline-flex items-center overflow-hidden rounded-xl border border-gray-200 shadow-sm bg-white">
                                                    <span className={`px-4 py-2 text-[10px] font-black uppercase tracking-wider ${req.status === 'Approved' ? 'bg-emerald-50 text-emerald-600' :
